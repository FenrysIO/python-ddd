...
# from eventsourcing.EventSourceRepository import MySQLSourceRepository
...
#         super().__init__()
#         self.value = 0
#         self.complex_value = 0

#     def add(self, a, b):
#         self.mutate("adding", a + b)

#     def complex(self, a):
#         self.mutate("complex", a)

#     def on_complex(self, event):
#         self.complex_value = event

#     def on_adding(self, event):
#         self.value = event


# class AddInMemoryRepository(MySQLSourceRepository):
#     def __init__(self):
#         super().__init__()
...
# def test_complex():
#     obj = AddDomainObject()
#     val = {"laurent": 1, "test": [1, 2, 3]}
#     obj.complex(val)
#     repo = AddInMemoryRepository()
#     repo.save(obj)

#     reloaded = repo.load(obj.object_id)
#     assert reloaded.complex_value == val
